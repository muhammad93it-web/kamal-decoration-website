...
<div class="help-box">
  💡 <?= e(t('a_qr_help', 'هەر QRێک لینکی تایبەتی بەرهەم/ڕەنگەکە لەخۆدەگرێت. کاتێک ماڵپەڕەکە دەگوازیتەوە بۆ دۆمەینی نوێ (نموونە: kamaldecoration.com)، لێرە لینکەکە بگۆڕە و پاشان دوگمەی «نوێکردنەوەی هەموو» دابگرە بۆ ئەوەی هەموو QRەکان بە لینکی نوێ دروستببنەوە.')) ?>
</div>
...
<div class="panel" style="max-width:720px">
  ...
  <form method="post" style="display:flex;gap:10px;flex-wrap:wrap">
    ...
    <input type="text" name="site_url" dir="ltr" value="<?= e($siteUrl) ?>" placeholder="https://kamaldecoration.com" style="flex:1;min-width:260px">
