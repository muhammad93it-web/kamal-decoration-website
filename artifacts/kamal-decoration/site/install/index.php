<?php
/**
 * دیکۆراتی کەمال — دامەزرێنەری کوردی
...
<title>دامەزراندن — دیکۆراتی کەمال</title>
<style>
...
<body>
<div class="card">
  <h1>دیکۆراتی کەمال — دامەزراندن</h1>
  <div class="sub">Kamal Decoration — Installer</div>
  ...
  <?php elseif ($step === '2'): ?>
    ...
    <form method="post">
      ...
      <input type="text" name="name" dir="ltr" value="<?= ie((string)($_POST['name'] ?? '')) ?>" placeholder="user_kamal">
      <label>ناوی بەکارهێنەری بنکەدراوە</label>
      <input type="text" name="user" dir="ltr" value="<?= ie((string)($_POST['user'] ?? '')) ?>" placeholder="user_kamal">
  ...
  <?php elseif ($step === '3'): ?>
    ...
    <form method="post">
      ...
      <input type="text" name="display_name" value="<?= ie((string)($_POST['display_name'] ?? 'کەمال')) ?>">
