...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <?php else: ?>
        <div class="footer-brand"><?= e(setting('site_name', 'دیکۆراتی ڕەوەند')) ?></div>
      <?php endif; ?>
  ...
  <div class="footer-bottom">
    <div class="container">
      <span>© <?= date('Y') ?> <?= e(setting('site_name', 'دیکۆراتی ڕەوەند')) ?> — <?= e(t('footer_rights')) ?> <span class="site-ver" dir="ltr"><?= e(KD_VERSION) ?></span></span>
